...
//        Logger.error("BEGIN KICK OUT Session Not Connect COUNT: " + GirlkunSessionManager.gI().getSessions().size() + "\n");
    ...
    public void createBot(MySession s) {
        String[] name1 = {"obito", "uchiha", "naruto", "doraemon", "haha", "hehe"};
        String[] name2 = {"siin", "tuan", "ndt", "obito", "huhu", "nobita"};
        String[] name3 = {"sensie", "chan", "kakashi", "lee", "madara", "itachi"};
        ...
        //skill
        int[] skillsArr = pl.gender == 0 ? new int[]{0, 1, 6, 9, 10, 20, 22, 19, 27}
