...
import static ServerData.Models.Item.ItemTime.TIME_ITEM;
        ...
        if (!this.beforeDispose && !isBot) {
            try {
                if (iDMark != null && !iDMark.isBan()) {
                    ...
                    if (this.autobv == true && this.sovangauto != 0 && this.inventory.gold + 500000000 < InventoryServiceNew.gI().getGodMax(this)) {
                        try {
                            Item tv = InventoryServiceNew.gI().findItem(this.inventory.itemsBag, 457);
                            if (tv != null && tv.quantity > 1) {
                                if (this.inventory.gold < sovangauto) {
                                    this.autobvrun = true;
                                    while (this.autobvrun == true) {
                                        if (this.inventory.gold < InventoryServiceNew.gI().getGodMax(this)) {
                                            ...
                                            this.autobvrun = false;
                                            Service.gI().sendThongBao(this, "Đã đạt giới hạn vàng\nAuto bán vàng đã tạm dừng!");
                                        }
                                    }
                                }
                            } else {
                                this.autobv = false;
                                Service.gI().sendThongBao(this, "|7|Không đủ thỏi vàng\nAuto bán vàng đã tắt!");
                            }
                        } catch (Exception e) {
...
//                    }
                    ...
                    if (this.isPl() && this.inventory != null && this.inventory.itemsBody.get(7) != null) {
                        ...
                        if (it != null && it.isNotNullItem() && this.newpet == null && this.newpet1 == null) {
                            switch (it.template.id) {
                                ...
                                case 1488:
                                    ...
                                    break;
                                case 1575:
                                    PetService.Pet2(this, 1563, 1564, 1565);
                                    Service.getInstance().point(this);
                                    break;
                                case 1576:
                                    PetService.Pet2(this, 1566, 1567, 1568);
                                    Service.getInstance().point(this);
                                    break;
                                case 1577:
                                    PetService.Pet2(this, 1569, 1570, 1571);
                                    Service.getInstance().point(this);
                                    break;
                                case 1578:
                                    ...
                                    break;
                                case 1579:
                                    PetService.Pet2(this, 1575, 1576, 1577);
                                    Service.getInstance().point(this);
                                    break;
                                case 1580:
                                    PetService.Pet2(this, 1614, 1615, 1616);
                                    Service.getInstance().point(this);
                                    break;
                                case 1581:
                                    PetService.Pet2(this, 1645, 1646, 1647);
                                    Service.getInstance().point(this);
                                    break;
                                case 1582:
                                    PetService.Pet2(this, 1648, 1649, 1650);
                                    Service.getInstance().point(this);
                                    break;
                                case 1583:
                                    PetService.Pet2(this, 1669, 1670, 1671);
                                    Service.getInstance().point(this);
                                    break;
                                case 1584:
                                    PetService.Pet2(this, 907, 908, 909);
                                    Service.getInstance().point(this);
                                    break;
                                case 1585:
                                    PetService.Pet2(this, 888, 889, 890);
                                    Service.getInstance().point(this);
                                    break;
                            }
                        }
