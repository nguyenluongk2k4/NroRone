...
//                            InventoryServiceNew.gI().sendItemBags(pl);
                        ...
                        case 1575:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1563, 1564, 1565);
                            Service.getInstance().point(pl);
                            break;
                        case 1576:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1566, 1567, 1568);
                            Service.getInstance().point(pl);
                            break;
                        case 1577:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1569, 1570, 1571);
                            Service.getInstance().point(pl);
                            break;
                        case 1578:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        ...
                        case 1579:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1575, 1576, 1577);
                            Service.getInstance().point(pl);
                            break;
                        case 1580:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1614, 1615, 1616);
                            Service.getInstance().point(pl);
                            break;
                        case 1581:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        ...
                        case 1582:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1648, 1649, 1650);
                            Service.getInstance().point(pl);
                            break;
                        case 1583:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 1669, 1670, 1671);
                            Service.getInstance().point(pl);
                            break;
                        case 1584:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 907, 908, 909);
                            Service.getInstance().point(pl);
                            break;
                        case 1585:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                            PetService.Pet2(pl, 888, 889, 890);
                            Service.getInstance().point(pl);
                            break;
                        case 1229:
                            InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        ...
                        case 1992:
                            if (pl.pet == null) {
                                ...
                                Service.gI().sendThongBao(pl, "Bạn đổi thành công đệ Goku Ultra");
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                            }
                            if (pl.pet != null && pl.pet.inventory.itemsBody.get(0).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(1).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(2).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(3).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(4).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(5).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(6).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(7).isNotNullItem() == false) {
                        ...
                        case 1990:
                            ...
                            if (pl.pet != null && pl.pet.inventory.itemsBody.get(0).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(1).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(2).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(3).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(4).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(5).isNotNullItem() == false && pl.pet.inventory.itemsBody.get(6).isNotNullItem() == false) {
...
//                            break;
                        ...
                        case 1342:
                            ...
                            break;
                        case 1625:
                            int counttv = Util.nextInt(5, 10);
                            Item tv = ItemService.gI().createNewItem((short) 457, counttv);
                            InventoryServiceNew.gI().sendItemBags(pl);
                            InventoryServiceNew.gI().addItemBag(pl, tv);
                            InventoryServiceNew.gI().subQuantityItem(pl.inventory.itemsBag, item, 1);
                            Service.gI().sendThongBao(pl, "Bạn nhận được " + counttv + " thỏi vàng");
                            break;
                        case 1626:
                            int counthn = Util.nextInt(500, 1000);
                            Item hn = ItemService.gI().createNewItem((short) 861, counthn);
                            InventoryServiceNew.gI().sendItemBags(pl);
                            InventoryServiceNew.gI().addItemBag(pl, hn);
                            InventoryServiceNew.gI().subQuantityItem(pl.inventory.itemsBag, item, 1);
                            Service.gI().sendThongBao(pl, "Bạn nhận được " + counthn + " hồng ngọc");
                            break;
                        case 569:
                        ...
                        case 1607: {
                            if (InventoryServiceNew.gI().getCountEmptyBag(pl) == 0) {
                                ...
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                                Item sachCo = ItemService.gI().createNewItem((short) 1603, 1);
                                Item an = ItemService.gI().createNewItem((short) Util.nextInt(1604, 1606), 1);
                                InventoryServiceNew.gI().addItemBag(pl, sachCo);
                                InventoryServiceNew.gI().addItemBag(pl, an);
                                InventoryServiceNew.gI().sendItemBags(pl);
                                Service.gI().sendThongBao(pl, "Chúc mừng bạn nhận được " + sachCo.template.name + "và " + an.template.name);
                            }
                        }
                        break;
                        case 1530: {
                            if (InventoryServiceNew.gI().getCountEmptyBag(pl) == 0) {
                                ...
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                                Item queKem = ItemService.gI().createNewItem((short) 1531, 1);
                                InventoryServiceNew.gI().addItemBag(pl, queKem);
                                InventoryServiceNew.gI().sendItemBags(pl);
                                Service.gI().sendThongBao(pl, "Chúc mừng bạn nhận được " + queKem.template.name);
                            }
                        }
                        break;
                        case 1628:
    ...
    public String getParamValueById(String jsonString, String id) {
        // Tìm vị trí của "id:72"
        String targetId = "id:" + "72";
        int startIndex = jsonString.indexOf(targetId);

        if (startIndex == -1) {
            return null;
        }

        // Tìm vị trí của "param:" bắt đầu từ vị trí của "id:72"
        int paramIndex = jsonString.indexOf("param:", startIndex);
        if (paramIndex == -1) {
            return null;
        }

        // Tìm giá trị của "param" bắt đầu sau "param:"
        int valueStart = paramIndex + "param:".length();

        // Tìm vị trí kết thúc của giá trị "param", có thể là dấu phẩy hoặc dấu ngoặc đóng
        int valueEnd = jsonString.indexOf(",", valueStart);
        if (valueEnd == -1) { // Nếu không có dấu phẩy, tìm dấu ngoặc đóng
        ...
        // Trích xuất giá trị của "param"
        String value = jsonString.substring(valueStart, valueEnd).trim();
...
//        if (time != 0) {
        if (true) {
            ...
            System.out.print(item.itemOptions.get(0).param);
            int gold = 0;
...
//         RewardService.gI().initBaseOptionSaoPhaLe(itemReward);
            ...
            if (param == 11) {
                itemReward = ItemService.gI().createNewItem((short) 1627);
                itemReward.quantity = Util.nextInt(1, 5);
                InventoryServiceNew.gI().addItemBag(pl, itemReward);
                pl.textRuongGo.add(text + itemReward.getInfoItem());
            }
            NpcService.gI().createMenuConMeo(pl, 1000000, -1, "Bạn nhận được\n|1|+" + Util.numberToMoney(gold) + " vàng", "OK [" + pl.textRuongGo.size() + "]");
            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
    ...
    private void hopquatt(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            ...
            short[] icon = new short[2];
            icon[0] = item.template.iconID;
            Item it = ItemService.gI().createNewItem((short) 1333);
        ...
        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 5) {
            ...
            try {
                ...
                if (player.getSession().tongnap >= 100000 && player.mocnap == 0) {
                    ...
                    itemqua = ItemService.gI().createNewItem((short) 457, 100);
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua1 = ItemService.gI().createNewItem((short) 1296, 10);
                    itemqua2 = ItemService.gI().createNewItem((short) 2000, 5);
                    ...
                    itemqua3 = ItemService.gI().createNewItem((short) 1465, 10);
                    ...
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua2 = ItemService.gI().createNewItem((short) 1296, 10);
                    itemqua3 = ItemService.gI().createNewItem((short) 1465, 15);
                    ...
                    itemqua3 = ItemService.gI().createNewItem((short) 1465, 20);
                    itemqua4 = ItemService.gI().createNewItem((short) 1997, 10);
                    ...
                    itemqua = ItemService.gI().createNewItem((short) 457, 800);
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua2 = ItemService.gI().createNewItem((short) 1296, 20);
                    itemqua3 = ItemService.gI().createNewItem((short) 1465, 30);
                    ...
                    itemqua1.itemOptions.add(new Item.ItemOption(50, 15));
                    itemqua1.itemOptions.add(new Item.ItemOption(77, 15));
                    itemqua1.itemOptions.add(new Item.ItemOption(103, 15));
                    itemqua6 = ItemService.gI().createNewItem((short) 1504, 100);
        ...
        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 4) {
            ...
            try {
                ...
                if (player.pointSb >= 100 && player.mocsanboss == 0) {
                    ...
                    itemqua = ItemService.gI().createNewItem((short) 457, 10);
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua1 = ItemService.gI().createNewItem((short) 1318, 50);
                    ...
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua1 = ItemService.gI().createNewItem((short) 1318, 200);
                    itemqua3 = ItemService.gI().createNewItem((short) 1296, 5);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua1.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua3.template.name);
                    ...
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua1 = ItemService.gI().createNewItem((short) 1318, 400);
                    itemqua3 = ItemService.gI().createNewItem((short) 1296, 5);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua1.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua3.template.name);
                    ...
                    itemqua = ItemService.gI().createNewItem((short) 457, 40);
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua1 = ItemService.gI().createNewItem((short) 1318, 600);
                    itemqua3 = ItemService.gI().createNewItem((short) 1296, 5);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua1.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua3.template.name);
                    ...
                    itemqua = ItemService.gI().createNewItem((short) 457, 80);
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua1 = ItemService.gI().createNewItem((short) 1318, 800);
                    itemqua3 = ItemService.gI().createNewItem((short) 1296, 5);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua1.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua3.template.name);
                    ...
                    itemqua = ItemService.gI().createNewItem((short) 457, 100);
                    itemqua.itemOptions.add(new Item.ItemOption(30, 1));
                    itemqua1 = ItemService.gI().createNewItem((short) 1318, 1000);
                    itemqua3 = ItemService.gI().createNewItem((short) 1296, 5);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua1.template.name);
                    Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + itemqua3.template.name);
...
//                }
                ...
                ChangeMapService.gI().changeMapBySpaceShip(pl, 122, Util.nextInt(3), 115);
            ...
            case 2105: //máy dò đồ
                ...
                break;
            case 1525:
                if (pl.itemTime.isNong) {
                    pl.itemTime.isNong = false;
                    pl.itemTime.lastTimeNong = 0;
                    ItemTimeService.gI().removeTextTime(pl, ItemTime.TEXT_NONG);
                } else if (pl.itemTime.isUseMiaThom) {
                    pl.itemTime.isUseMiaThom = false;
                    pl.itemTime.lastTimeMiaThom = 0;
                    ItemTimeService.gI().removeItemTime(pl, 13463);
                } else if (pl.itemTime.isUseMiaSauRieng) {
                    pl.itemTime.isUseMiaSauRieng = false;
                    pl.itemTime.lastTimeMiaSauRieng = 0;
                    ItemTimeService.gI().removeItemTime(pl, 13464);
                }
                pl.itemTime.lastTimeMiaKhongLo = System.currentTimeMillis();
                pl.itemTime.isUseMiaKhongLo = true;
                break;
            case 1526:
                if (pl.itemTime.isNong) {
                    pl.itemTime.isNong = false;
                    pl.itemTime.lastTimeNong = 0;
                    ItemTimeService.gI().removeTextTime(pl, ItemTime.TEXT_NONG);
                } else if (pl.itemTime.isUseMiaKhongLo) {
                    pl.itemTime.isUseMiaKhongLo = false;
                    pl.itemTime.lastTimeMiaKhongLo = 0;
                    ItemTimeService.gI().removeItemTime(pl, 13462);
                } else if (pl.itemTime.isUseMiaSauRieng) {
                    pl.itemTime.isUseMiaSauRieng = false;
                    pl.itemTime.lastTimeMiaSauRieng = 0;
                    ItemTimeService.gI().removeItemTime(pl, 13464);
                }
                pl.itemTime.lastTimeMiaThom = System.currentTimeMillis();
                pl.itemTime.isUseMiaThom = true;
                break;
            case 1527:
                if (pl.itemTime.isNong) {
                    pl.itemTime.isNong = false;
                ...
                pl.itemTime.lastTimeMiaSauRieng = System.currentTimeMillis();
                pl.itemTime.isUseMiaSauRieng = true;
                break;
        }
        Service.gI().point(pl);
