...
//        int per = lastLevel ? 10 : 20;
    ...
    public static int getTimeSSJ(int level) { //thời gian tồn tại SSJ
        return (level + 5) * 10000;
    }

    public static int getPercentHpSSJ(int level) { //tỉ lệ máu SSJ cộng thêm
        return (level + 3) * 10;
    }
    
    public static int getPercentDameSSJ(int level) { //tỉ lệ dam SSJ cộng thêm
        return (level + 3);
    }
...
//        return 10000;
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1608 && tempId <= 1623) {
