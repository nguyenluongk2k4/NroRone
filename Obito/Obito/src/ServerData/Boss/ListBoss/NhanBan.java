...
public class NhanBan extends Boss {
    ...
    public void reward(Player plKill) {
        //vật phẩm rơi khi diệt boss nhân bản
         int[] itemDos = new int[]{381,382,383,384,385};
        int randomDo = new Random().nextInt(itemDos.length);
        ItemMap it = new ItemMap(this.zone, 861,Util.nextInt(10,50), this.location.x, this.zone.map.yPhysicInTop(this.location.x+5,
