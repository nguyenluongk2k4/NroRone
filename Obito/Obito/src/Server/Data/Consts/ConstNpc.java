...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
            ...
            + "1 sao: 10% SĐ \n2 sao: 10% HP \n3 sao: 10% KI \n4 sao: 10% Chí Mạng \n5 sao: 10% Hút HP và KI \n6 sao: 20% ST Lên Quái \n7 sao: 10% PST";
    ...
    public static final int MENU_PHA_LE_HOA_VIP = 1007;
    public static final int MENU_CHAN_MENH = 1008;
    public static final int MENU_NANG_SKH_TL_LVL = 1005;
    public static final int MENU_CHE_TAO_PHOI = 1009;
    ...
    public static final byte XEMIA = 88;
    public static final byte GOHANBAIBIEN = 89;
    //
    ...
    public static final String NAME = "thanggg";
    ...
    //index bulma ao dai
    public static final int KHAM_NGOC_BOI = 500;
    public static final int KICH_AN = 528;
    public static final int DOI_AN = 529;
    public static final int SACH_TUYET_KI = 530;
    public static final int CHE_TAO_PHOI = 531;
    ...
    public static final int MENU_NANG_DOI_SKH_THUONG = 509;
